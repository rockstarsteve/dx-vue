...
window.BMAP_AUTHENTIC_KEY = "OswGiA4cXLRKH5xc1ucdAVf1Tfk6ky8b";
(function () {
  function aa(a) {
    throw a;
  }
  ...
  z.U.ka = function (a) {
    ...
    var f = {
        ...
        g;
    if (a == (c.na && !c.MD ? b.body : b.documentElement)) return f;
    if (a.getBoundingClientRect) {
      ...
      if (c.opera > 0 || c.HL > 0 && e(a, "position") == "absolute") f.top = f.top - b.body.offsetTop;
  ...
  z.lK = function () {
    function a(a) {
      document.addEventListener && (this.element = a, this.oK = this.tk ? "touchstart" : "mousedown", this.EC = this.tk ? "touchmove" : "mousemove", this.DC = this.tk ? "touchend" : "mouseup", this.ih = t, this.Gt = this.Ft = 0, this.element.addEventListener(this.oK, this, t), ja.V(this.element, "mousedown", u()), this.handleEvent(q))
    }
    ...
    a.prototype = {
      ...
      move: function (a) {
        ...
        if (10 < Math.abs((this.tk ? a.touches[0].clientX : a.clientX) - this.Ft) || 10 < Math.abs(c - this.Gt)) this.ih = p
      },
      end: function (a) {
        oa(a);
  ...
  D.l0 = D.verify ||
      function () {
        D.version && D.version >= 1.5 && pa(D.md + "?qt=verify&ak=" + qa,
            function (a) {
              if (a && a.error !== 0) {
  ...
  function Na(a, b) {
    if (a = z.ea(a)) {
      ...
      c.R.we && (this.TX(c.R.we.controls), this.vL(c.R.we.geotableId));
      ...
      if (-1 < navigator.userAgent.toLowerCase().indexOf("UCBrowser") || e && f) c.R.lF = 99;
      c.Ya = a;
      c.QA(a);
      a.unselectable = "on";
      a.innerHTML = "";
      ...
      for (f = 0; f < D.Vq.length; f++) D.Vq[f](c);
      c.aa.rE = f;
      c.ga();
      K.load("map",
          function () {
  ...
  z.extend(Na.prototype, {
    ...
    Xj: function (a, b, c, e) {
      var f = this.va().Yb(this.ja()),
          g = this.Ic,
          i = p;
      c && J.zL(c) && (this.oe = new J(c.lng, c.lat), i = t);
      if (c = c && e ? g.ci(c, this.Qb) : this.Zb) if (this.Zb = new J(c.lng + a * f, c.lat - b * f), (a = g.hh(this.Zb, this.Qb)) && i) this.oe = a
    },
    Dg: function (a, b) {
      if (Ya(a) && (this.su(), this.dispatchEvent(new Q("onzoomstart")), a = this.wn(a).zoom, a !== this.Va)) {
        this.zc = this.Va;
        this.Va = a;
        var c;
        b ? c = b : this.dh() && (c = this.dh().ka());
        c && (c = this.Rb(c, this.zc), this.Xj(this.width / 2 - c.x, this.height / 2 - c.y, this.Gb(c, this.zc), p));
    ...
    ki: function (a) {
      a instanceof J && (this.Zb = this.Ic.ci(a, this.Qb), this.oe = J.zL(a) ? new J(a.lng, a.lat) : this.Ic.hh(this.Zb, this.Qb))
    },
    yg: function (a, b) {
      a = Math.round(a) || 0;
      b = Math.round(b) || 0;
    ...
    tr: function (a) {
      a && Za(a.Fe) && (a.Fe(this), this.dispatchEvent(new Q("onaddcontrol", a)))
    },
    XM: function (a) {
      a && Za(a.remove) && (a.remove(), this.dispatchEvent(new Q("onremovecontrol", a)))
    },
    Yn: function (a) {
      a && Za(a.xa) && (a.xa(this), this.dispatchEvent(new Q("onaddcontextmenu", a)))
    },
    bp: function (a) {
      a && Za(a.remove) && (this.dispatchEvent(new Q("onremovecontextmenu", a)), a.remove())
    },
    Oa: function (a) {
      a && Za(a.Fe) && (a.Fe(this), this.dispatchEvent(new Q("onaddoverlay", a)))
    },
    Sb: function (a) {
      a && Za(a.remove) && (a.remove(), this.dispatchEvent(new Q("onremoveoverlay", a)))
    },
    CJ: function () {
    ...
    WZ: function (a) {
      a === $a || a === Ua ? (this.Sx(p), this.oN(t), this.R.pg = t, this.R.gk = t) : (this.Sx(t), this.oN(p), this.R.pg = p, this.R.gk = p)
    },
    rf: function (a) {
      var b = this;
      ...
      else if (ab(a)) if (b.Ta === Ra) {
        var c = H.AB[a];
        c && (pt = c.o, b.rf(pt))
      } else {
        var e = this.dH();
        e.vt(function (c) {
          0 === e.fm() && 2 === e.La.result.type && (b.rf(c.pk(0).point), Ra.kk(a) && b.FE(a))
        });
        e.search(a, {
          log: "center"
        })
    ...
    Dd: function (a, b) {
      ...
      if (ab(a)) if (c.Ta === Ra) {
        ...
        g.zoom = b;
        c.loaded || (c.loaded = p, c.dispatchEvent(g), ua || (ua = cb()));
        c.dispatchEvent(i);
        g = new Q("onmoveend");
        g.kz = "centerAndZoom";
        e.Wb(c.oe) || c.dispatchEvent(g);
        c.dispatchEvent(new Q("onmoveend"));
        c.zc !== c.Va && (e = new Q("onzoomend"), e.kz = "centerAndZoom", c.dispatchEvent(e));
        c.R.to && c.to()
      }
    },
    dH: function () {
    ...
    disableAutoResize: function () {
      this.R.Yr = t;
      this.aa.Ml && (clearInterval(this.aa.Ml), this.aa.Ml = q)
    },
    ...
    BV: function () {
      this.R.to = t;
      this.dn && (this.Wf(this.dn), this.dn = q, delete this.dn)
    },
    Cb: function () {
      return this.Lr && this.Lr instanceof P ? new P(this.Lr.width, this.Lr.height) : new P(this.Ya.clientWidth, this.Ya.clientHeight)
    },
    Ae: function (a) {
      a && a instanceof P ? (this.Lr = a, this.Ya.style.width = a.width + "px", this.Ya.style.height = a.height + "px") : this.Lr = q
    },
    Bb: x("oe"),
    ja: x("Va"),
    PU: function () {
    ...
    B4: function (a, b) {
      var c = map.Qb;
      this.Ta === Ra && c && (a.x += this.offsetX, a.y += this.offsetY, eb.HJ(a, this, b))
    },
    se: function (a) {
    ...
    eR: function (a, b) {
      for (var c = this.va(), e = b.margins || [10, 10, 10, 10], f = b.zoomFactor || 0, g = e[1] + e[3], e = e[0] + e[2], i = c.lf(), k = c = c.Re(); k >= i; k--) {
        var m = this.va().Yb(k);
        if (a.dF().lng / m < this.width - g && a.dF().lat / m < this.height - e) break
      }
      k += f;
      k < i && (k = i);
      k > c && (k = c);
    ...
    ws: function (a, b) {
      ...
      if (!a || !a instanceof fb && 0 === a.length || a instanceof fb && a.kj()) return c;
      var e = [];
      a instanceof fb ? (e.push(a.Of()), e.push(a.Te())) : e = a.slice(0);
      for (var b = b || {},
               f = [], g = 0, i = e.length; g < i; g++) f.push(this.Ic.ci(e[g], this.Qb));
      e = new fb;
      for (g = f.length - 1; 0 <= g; g--) e.extend(f[g]);
      if (e.kj()) return c;
      c = e.Bb();
      f = this.eR(e, b);
      b.margins && (e = b.margins, g = (e[1] - e[3]) / 2, e = (e[0] - e[2]) / 2, i = this.va().Yb(f), b.offset && (g = b.offset.width, e = b.offset.height), c.lng += i * g, c.lat += i * e);
    ...
    uX: x("Bd"),
    hu: function () {
      for (var a = this.aa.rE; a < D.Vq.length; a++) D.Vq[a](this);
      this.aa.rE = a
    },
    FE: function (a) {
      this.Qb = Ra.kk(a);
    ...
    jB: function (a, b) {
      ...
      a.tag = b;
      a instanceof ib && (this.Ah[b][a.da] = a, a.xa(this));
      var c = this;
      K.load("hotspot",
          function () {
            c.hu()
    ...
    YZ: function (a) {
      ...
      window[e + "cb"] = function (a) {
        a = JSON.parse(a);
        0 === a.status && (3 === a.data.style.length ? (window[e + "_bmap_baseFs"] = a.data.style, window[e + "StyleBody"] = a.data.style[2]) : window[e + "StyleBody"] = a.data.style, c.eO(), c.$X())
      };
      if (a.styleId) {
        var g = "jsapi";
    ...
    mt: function (a) {
      ...
      if (a) {
        ...
        I() && z.fa.Ox ? setTimeout(function () {
            ...
            50) : (this.R.we = a, this.dispatchEvent(new Q("onsetcustomstyles", a)), this.vL(b.R.we.geotableId));
        var c = {
          style: a.style
        };
    ...
    TX: function (a) {
      ...
      var b = this,
          c;
      for (c in this.controls) b.XM(b.controls[c]);
      a = a || [];
      z.kc.Mb(a,
          function (a) {
            b.tr(b.controls[a])
    ...
    vL: function (a) {
      a ? this.Jr && this.Jr.zf === a || (this.Wf(this.Jr), this.Jr = new ob({
        geotableId: a
    ...
    WE: function (a, b) {
      for (var c = this.da,
               ...
               g = [], i = this.Ta.lf(); i <= this.Ta.Re(); i++) window[c + "zoomFrontStyle"][i] = {};
      window[c + "zoomFrontStyle"].main = {};
      for (var i = 0,
               k; k = a[i]; i++) if (!this.iY(k)) {
        b = this.NW(k, b);
        ...
        z.extend(m, k);
        k = [];
        for (var n in e) if (m[n] && !this.eY(n)) if ("elementType" === n) k.push(e[n] + ":" + f[m[n]]);
        else {
          switch (m[n]) {
            case "poilabel":
              m[n] = "poi";
    ...
    a0: function (a, b) {
      ...
      if (!window[c + "zoomRegion"][b]) for (var e = this.Ta.lf(), f = this.Ta.Re(); e <= f; e++) window[c + "zoomRegion"][e] || (window[c + "zoomStyleBody"][e] = a)
    },
    eO: function () {
      var a = this.da;
      if (window[a + "zoomFrontStyle"].main.bmapRoadarrowVisibility) for (var b = this.Ta.lf(); b <= this.Ta.Re(); b++) window[a + "zoomFrontStyle"][b].bmapRoadarrowVisibility || (window[a + "zoomFrontStyle"][b].bmapRoadarrowVisibility = window[a + "zoomFrontStyle"].main.bmapRoadarrowVisibility);
      if (window[a + "zoomFrontStyle"].main.bmapLandColor) for (b = this.Ta.lf(); b <= this.Ta.Re(); b++) window[a + "zoomFrontStyle"][b].bmapLandColor || (window[a + "zoomFrontStyle"][b].bmapLandColor = window[a + "zoomFrontStyle"].main.bmapLandColor);
      if (window[a + "zoomFrontStyle"].main.bmapRailwayFillColor) for (b = this.Ta.lf(); b <= this.Ta.Re(); b++) window[a + "zoomFrontStyle"][b].bmapRailwayFillColor || (window[a + "zoomFrontStyle"][b].bmapRailwayFillColor = window[a + "zoomFrontStyle"].main.bmapRailwayFillColor);
      if (window[a + "zoomFrontStyle"].main.bmapRailwayStrokeColor) for (b = this.Ta.lf(); b <= this.Ta.Re(); b++) window[a + "zoomFrontStyle"][b].bmapRailwayStrokeColor || (window[a + "zoomFrontStyle"][b].bmapRailwayStrokeColor = window[a + "zoomFrontStyle"].main.bmapRailwayStrokeColor);
      if (window[a + "zoomFrontStyle"].main.bmapRailwayVisibility) for (b = this.Ta.lf(); b <= this.Ta.Re(); b++) window[a + "zoomFrontStyle"][b].bmapRailwayVisibility || (window[a + "zoomFrontStyle"][b].bmapRailwayVisibility = window[a + "zoomFrontStyle"].main.bmapRailwayVisibility)
    },
    U1: function (a, b) {
      var c = {};
      z.extend(c, a);
      if (c[b]) {
        for (var e = this.Ta.lf(), f = this.Ta.Re(); e <= f; e++) if (!c[e]) {
          c[e] = p;
          break
        }
        delete c[b]
  ...
  D.Yh = function (a, b) {
    ...
    switch (a) {
      ...
      default:
        e = D.url.domain[a],
            "[object Array]" == Object.prototype.toString.call(e) ? (c = [], z.kc.Mb(e,
                function (a, e) {
                  c[e] = D.url.proto + a + "/" + b
  ...
  function xb(a) {
    var b = cb();
    b >= a.jz ? (Za(a.m.za) && a.m.za(a.m.bc(1)), Za(a.m.finish) && a.m.finish(), 0 < a.Zf.length && (b = a.Zf[0], b.Zf = [].concat(a.Zf.slice(1)), b.start())) : (a.Px = a.m.bc((b - a.ju) / a.m.duration), Za(a.m.za) && a.m.za(a.Px), a.YE || (a.or = setTimeout(function () {
          xb(a)
        },
        1E3 / a.m.Gc)))
  }
  ...
  ub.prototype.stop = function (a) {
    ...
    for (var b = 0; b < this.Zf.length; b++) this.Zf[b].stop(),
        this.Zf[b] = q;
    this.Zf.length = 0;
    this.or && (clearTimeout(this.or), this.or = q);
    this.m.Ys(this.Px);
    a && (this.jz = this.ju, xb(this))
  };
      ...
      function (a, b, c) {
        void
            function (a, b, c) {
              function i(a) {
                if (!a.po) {
                  for (var c = p,
                           e = [], g = a.wZ, k = 0; g && k < g.length; k++) {
                    var m = g[k],
                        n = ea[m] = ea[m] || {};
                    if (n.po || n == a) e.push(n.Mc);
                    else {
                      c = t;
                      if (!n.wV && (m = (va.get("alias") || {})[m] || m + ".js", !N[m])) {
                        N[m] = p;
              ...
              if (!B || !B.po) {
                var C = b.all && a.attachEvent,
                    ...
                    L = function (a) {
                      ...
                      if ("define" == a || "require" == a) {
                        ...
                        c = !c ? "#" + G++ : c;
                        e = ea[c] = ea[c] || {};
                        e.po || (e.name = c, e.wZ = f, e.PJ = g, "define" == a && (e.wV = p), i(e))
                ...
                y.prototype.start = y.prototype.create = function (a) {
                  if (!this.OJ) {
                    ...
                    this.OJ = new Date;
                    for (this.bs("create", this); a = this.lJ.shift();) v.apply(this, a)
                  }
                };
        ...
        void
            function (a, b, c) {
              ...
              s && (s.mh && m() < s.mh) && (c.alog("cus.on", "time",
                  function (a) {
                    var b = {},
                        e = t,
                        f;
              ...
              if (v && v.mh && m() < v.mh) {
                var C = ["Moz", "O", "ms", "Webkit"],
                    ...
                    Ni = function () {
                      return "Promise" in a && "cast" in a.Jp && "resolve" in a.Jp && "reject" in a.Jp && "all" in a.Jp && "race" in a.Jp &&
                          function () {
                            var b;
                            new a.Jp(function (a) {
                              b = a
                    ...
                    function () {
                      ...
                      var a = setInterval(function () {
                            if ("WebP-lossy" in Ub.Uh && "WebP-lossless" in Ub.Uh && "WebP-alpha" in Ub.Uh && "WebP-animation" in Ub.Uh) {
                              for (var b in Ub.Uh) Ub.Uh[b] = Ub.Uh[b] ? "y" : "n";
  ...
  function pa(a, b) {
    if (/^http/.test(a)) return;//这里判断一下，如果是调用外部资源就退出去好了
    if (b) {
  ...
  z.object.extend(K, {
    ...
    EJ: function (a) {
      if (a && this.GK()[a]) for (var a = this.GK()[a], b = 0; b < a.length; b++) this.EJ(a[b]),
      this.Pd.ml[a[b]] || this.TM(a[b])
    },
    TM: function (a) {
      for (var b = 0; b < this.Pd.Xm.length; b++) if (this.Pd.Xm[b] == a) return;
      this.Pd.Xm.push(a)
    },
    AZ: function (a, b) {
      var c = this.mb(a);
      ...
      c.Ke = this.uj.Cp;
      for (var f = 0,
               g = c.ou.length; f < g; f++) c.ou[f]();
      c.ou.length = 0
    },
    zJ: function (a, b) {
      var c = this;
      c.timeout = setTimeout(function () {
            c.Pd.ml[a].Ke != c.uj.Cp ? (c.remove(a), c.load(a, b)) : clearTimeout(c.timeout)
          },
          c.EF.NT)
    },
    mb: function (a) {
      this.Pd.ml[a] || (this.Pd.ml[a] = {},
          this.Pd.ml[a].Ke = this.uj.NF, this.Pd.ml[a].ou = []);
      return this.Pd.ml[a]
    },
    remove: function (a) {
      delete this.mb(a)
    ...
    MU: function (a, b) {
      for (var c = this.Pd.sv,
               e = p,
               f = 0,
               g = c.length; f < g; f++) "" == c[f].cE && (c[f].kM == a ? c[f].cE = b : e = t);
      e && this.nK()
    },
    nK: function () {
      for (var a = this.Pd.sv,
               b = 0,
               c = a.length; b < c; b++) this.AZ(a[b].kM, a[b].cE);
      this.Pd.sv.length = 0
    }
  });
  ...
  function ib(a, b) {
    a && (this.Kb = a, this.da = "spot" + ib.da++, b = b || {},
        this.Tg = b.text || "", this.Yu = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.bB = b.userData || q, this.Ch = b.minZoom || q, this.Ef = b.maxZoom || q)
  }
  ...
  z.extend(Tb.prototype, {
    ...
    remove: function () {
      this.M = q;
      this.P && (this.P.parentNode && this.P.parentNode.removeChild(this.P), this.P = this.P.Dq = q)
    },
    Ea: function () {
    ...
    rc: function (a) {
      if (this.J1 || !Ya(a) || isNaN(a) || a < Vb || 3 < a) a = this.defaultAnchor;
      this.m = this.m || {
        Ag: t
      };
    ...
    Kd: function (a) {
      a instanceof P && (this.m = this.m || {
        Ag: t
          ...
          this.m.Da = new P(a.width, a.height), this.P && this.rc(this.m.anchor))
    },
    aj: function () {
      return this.m.Da
    },
    ...
    $: function () {
      this.Sa != t && (this.Sa = t, this.P && z.U.$(this.P))
    },
  ...
  z.object.extend(ec.prototype, {
    ...
    uE: function (a) {
      if (this.De[a]) {
        for (var b = 0,
                 c = this.Aa.length; b < c; b++) this.Aa[b] && ("divider" == this.Aa[b].Lb && this.Aa[b].Bj == a) && (this.Aa.splice(b, 1), c--),
  ...
  function fb(a, b) {
    ...
    a && (this.Dl = new J(a.lng, a.lat), this.pl = new J(b.lng, b.lat), this.Le = a.lng, this.Xd = a.lat, this.Ge = b.lng, this.Vd = b.lat)
  }
  ...
  z.object.extend(fb.prototype, {
    ...
    Es: function (a) {
      if (!(a instanceof fb) || Math.max(a.Le, a.Ge) < Math.min(this.Le, this.Ge) || Math.min(a.Le, a.Ge) > Math.max(this.Le, this.Ge) || Math.max(a.Xd, a.Vd) < Math.min(this.Xd, this.Vd) || Math.min(a.Xd, a.Vd) > Math.max(this.Xd, this.Vd)) return q;
    ...
    extend: function (a) {
      if (a instanceof J) {
        ...
        if (!this.Ge || this.Ge < b) this.pl.lng = this.Ge = b;
        if (!this.Xd || this.Xd > a) this.Dl.lat = this.Xd = a;
        if (!this.Vd || this.Vd < a) this.pl.lat = this.Vd = a
      }
    },
    dF: function () {
  ...
  z.extend(S, {
    ...
    fc: function (a) {
      ...
      for (var e = 0; e < this.RF.length; e++) if (b.lat >= this.RF[e]) {
        c = this.PO[e];
        break
      }
      a = this.JJ(a, c);
    ...
    gb: function (a) {
      ...
      b = new J(a.lng, a.lat);
      for (var e = 0; e < this.cu.length; e++) if (b.lat >= this.cu[e]) {
        c = this.OF[e];
        break
      }
      if (!c) for (e = 0; e < this.cu.length; e++) if (b.lat <= -this.cu[e]) {
        c = this.OF[e];
        break
      }
      a = this.JJ(a, c);
  ...
  z.extend(lc.prototype, {
    Fe: function (a) {
      if (!this.ba && Za(this.initialize) && (this.ba = this.initialize(a))) this.ba.style.WebkitUserSelect = "none";
      this.draw()
    },
    initialize: function () {
      aa("initialize\u65b9\u6cd5\u672a\u5b9e\u73b0")
  ...
  D.Xe(function (a) {
    ...
    z.fa.na && 8 > z.fa.na || "BackCompat" === document.compatMode ? a.addEventListener("zoomend",
        function (a) {
          setTimeout(function () {
                b.draw(a)
              },
    ...
    a.addEventListener("addoverlay",
        function (a) {
          a = a.target;
          if (a instanceof gb) b.Ba[a.da] || (b.Ba[a.da] = a);
          else {
            for (var e = t,
                     f = 0,
    ...
    a.addEventListener("removeoverlay",
        function (a) {
          a = a.target;
          if (a instanceof gb) delete b.Ba[a.da];
          else for (var e = 0,
    ...
    a.addEventListener("clearoverlays",
        function () {
          ...
          a = 0;
          for (var e = b.Ce.length; a < e; a++) b.Ce[a].enableMassClear !== t && (b.Ce[a].remove(), b.Ce[a] = q, b.Ce.splice(a, 1), a--, e--)
        });
  ...
  z.extend(nc.prototype, {
    ...
    Se: x("la"),
    Gm: function (a, b) {
      b && this.la[a] && (this.cf.length = 0, this.la[a] = new J(b.lng, b.lat), this.th())
    },
    ...
    OW: function () {
      for (var a = [], b = 0; b < this.la.length - 1; b++) var c = this.FU(this.la[b], this.la[b + 1]),
          a = a.concat(c);
  ...
  function rc(a, b, c, e) {
    a && (this.cv = {},
        this.rK = e ? !!e : t, this.Tc = [], this.z_ = a instanceof qc ? a : q, this.YH = b === l ? p : !!(b.indexOf("%") + 1), this.Oj = isNaN(parseFloat(b)) ? 1 : this.YH ? parseFloat(b) / 100 : parseFloat(b), this.ZH = !!(c.indexOf("%") + 1), this.repeat = c != l ? this.ZH ? parseFloat(c) / 100 : parseFloat(c) : 0)
  };
  ...
  z.extend(sc.prototype, {
    ...
    Za: da(t),
    ka: function () {
      if (this.sb && this.sb.ka) return this.sb.ka()
    },
    aj: function () {
      return this.K.Da
    }
  ...
  gb.prototype.Zc = function (a) {
    this.map && (this.map.Vc(), a.Sa = p, this.map.aa.gl = a, a.sb = this, z.lang.Ga.call(a, a.da))
  };
  gb.prototype.Vc = function () {
    this.map && this.map.aa.gl && (this.map.aa.gl.Sa = t, z.lang.sw(this.map.aa.gl.da), this.map.aa.gl = q)
  };
  ...
  function yc(a, b) {
    var c = this;
    xc() && (a === l && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && aa(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {},
        gb.apply(c, arguments), c.ha = {
      la: a
    },
        c.K = {
          shape: b.shape || vc,
        ...
        this.AA = [], this.me = [], K.load("pointcollection",
        function () {
          for (var a = 0,
                   b; b = c.AA[a]; a++) c[b.method].apply(c, b.arguments);
          for (a = 0; b = c.me[a]; a++) c[b.method].apply(c, b.arguments)
        }))
  }
  ...
  z.extend(W.prototype, {
    Tb: function (a) {
      if (a instanceof pc || a instanceof qc) this.K.ue = a
    },
    Do: function () {
      return this.K.ue
    },
  ...
  z.extend(Ec.prototype, {
    ...
    Gm: function (a, b) {
      this.Sn[a] && (this.Sn[a] = new J(b.lng, b.lat), this.la[a] = new J(b.lng, b.lat), 0 == a && !this.la[0].Wb(this.la[this.la.length - 1]) && (this.la[this.la.length - 1] = new J(b.lng, b.lat)), this.th())
    },
    Se: function () {
      var a = this.Sn;
  ...
  z.extend(Ic.prototype, {
    ...
    xf: function () {
      this.wk--;
      var a = this;
      this.GD && (this.map.dispatchEvent(new Q("onfirsttileloaded")), this.GD = t);
      0 == this.wk && (this.Ci && (clearTimeout(this.Ci), this.Ci = q), this.Ci = setTimeout(function () {
            if (a.wk == 0) {
    ...
    aL: function (a, b, c) {
      ...
      for (this.Be ? this.Be.length = 0 : this.Be = []; n < s; n++) for (var y = o; y < v; y++) {
        var A = n,
            B = y;
        this.Be.push([A, B]);
        A = m + "_" + b + "_" + A + "_" + B + "_" + g;
      ...
      for (e = this.Be.length; n < e; n++) {
        ...
        k = this.Be[n][1];
        y = 0;
        for (o = this.Ne.length; y < o; y++) if (s = this.Ne[y], s.id == m + "_" + b + "_" + C + "_" + k + "_" + g) {
          s.Aq = p;
          this.tm[s.id] = s;
          break
        }
      ...
      n = 0;
      for (e = this.Ne.length; n < e; n++) s = this.Ne[n],
      s.Aq || this.Oe.push(s);
      this.aF = [];
    ...
    n_: function (a, b, c, e) {
      ...
      m && m.Hb ? (yb(m.Hb, b), e && (e = new R(a[0], a[1]), g = this.map.R.we ? this.map.R.we.style : "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, Nc(m, e)), m.loaded ? this.xf() : Pc(m,
          function () {
            f.xf()
          })) : (m = this.Ti[i]) && m.Hb ? (c.Jb.insertBefore(m.Hb, c.Jb.lastChild), this.wg[i] = m, yb(m.Hb, b), e && (e = new R(a[0], a[1]), g = this.map.R.we ? this.map.R.we.style : "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, Nc(m, e)), m.loaded ? this.xf() : Pc(m,
          function () {
            f.xf()
          })) : (m = k * Math.pow(2, g.Re() - a[2]), new J(a[0] * m, a[1] * m), e = new R(a[0], a[1]), g = this.map.R.we ? this.map.R.we.style : "normal", e = c.getTilesUrl(e, a[2], g), m = new Qc(this, e, b, a, c), Pc(m,
          function () {
            f.xf()
          }), m.Bn(), this.wg[i] = m)
    },
    ...
    Zw: function (a) {
      var b = a.Hb;
      b && (Rc(b), Ab(b) && b.parentNode.removeChild(b));
      delete this.wg[a.name];
      a.loaded || (Rc(b), Mc(a), a.Hb = q, a.qm = q)
    },
    Vv: function (a, b) {
      for (var c = 0,
    ...
    HU: function (a) {
      for (var b = a.lng; b > this.hA;) b -= this.DH;
      for (; b < this.iA;) b += this.DH;
      a.lng = b;
      return a
    },
    IU: function (a, b) {
    ...
    Uf: function (a) {
      if (!this.map.R.pg) {
        var b = this;
        if (b.map.va() == Ra) K.load("coordtrans",
            function () {
              b.map.Qb || (b.map.Qb = Ra.kk(b.map.Xg), b.map.aw = Ra.DK(b.map.Qb));
              b.FH()
            },
            p);
        else {
    ...
    FH: function (a) {
      ...
      for (var k = 0; k < c; k++) {
        ...
        if (!m.o1 && !(m.ix && !this.map.Nd() || m.GL && this.map.Nd())) {
          ...
          m.Jb && (m.Jb.style.left = Math.ceil(A + C) - g[0] + "px", m.Jb.style.top = Math.ceil(B + E) - g[1] + "px", m.Jb.style.WebkitTransform = "translate3d(0,0,0)");
          A = [];
          for (e.dB = []; v < y; v++) for (B = o; B < f; B++) A.push([v, B]),
              e.dB.push({
                x: v,
                y: B
              });
          ...
          s = A.length;
          this.wk += s;
          for (v = 0; v < s; v++) this.n_([A[v][0], A[v][1], w], g, m, a)
        }
      }
    },
    cY: function (a, b) {
    ...
    mt: function (a) {
      var b = this.map.va();
      if (!this.map.Nd() && (a ? this.map.R.w_ = a : a = this.map.R.w_, a)) for (var c = q,
                                                                                     c = "2" == D.Pt ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] + "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[2] + "/"], e = 0, f; f = this.mj[e]; e++) if (f.i_ == p) {
        b.m.nc = 18;
    ...
    this.Hb.onload = function () {
      ...
      if (i.qm) {
        ...
        if (i.Hb && !Ab(i.Hb) && f.Jb) {
          ...
          if (z.fa.na <= 6 && z.fa.na > 0 && i.JI) i.Hb.style.cssText = i.Hb.style.cssText + (';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + i.src + '",sizingMethod=scale);')
        }
        var c = a.pE - a.DU,
            e;
        for (e in b) {
  ...
  z.extend(Lc.prototype, {
    ...
    getTilesUrl: function (a, b) {
      if (this.map.va() !== $a && this.map.va() !== Ua) var c = this.map.Ye.Vv(a.x, b).Sl;
      var e = "";
      this.Ue.tileUrlTemplate && (e = this.Ue.tileUrlTemplate.replace(/\{X\}/, c), e = e.replace(/\{Y\}/, a.y), e = e.replace(/\{Z\}/, b));
      return e
    },
    am: x("dV"),
    va: function () {
  ...
  ob.prototype.getTilesUrl = function (a, b) {
    ...
    f.kF || (f = (1E5 * Math.random()).toFixed(0), c += "&timeStamp=" + f);
  ...
  var cd = {
    drawPoly: function (a, b, c, e, f, g) {
      ...
      if (i) for (var a = a[6], k = 0; k < i.length; k++) {
        ...
        if (n && n.length) for (var o = i[k][1], s = 0; s < o.length; s++) {
          var v = o[s][1];
          f.Nc(v[0], c) && (v["cache" + c] || (v["cache" + c] = f.vm(v[1], c, e, a)), v = v["cache" + c], f.M.Xn(b.canvas.id, v, {
            type: "polygon",
            Ub: m,
            style: n
          }), this.UV(b, v, n, c))
    ...
    UV: function (a, b, c, e) {
      ...
      if (!c.Ub || !(6 < e && (71013 === c.Ub || 71012 === c.Ub || 71011 === c.Ub) || 6 === e && (71011 === c.Ub || 71012 === c.Ub) || 5 === e && (71011 === c.Ub || 71013 === c.Ub) || 5 > e && (71012 === c.Ub || 71013 === c.Ub))) {
        ...
        a.closePath();
        c.borderWidth && (a.strokeStyle = c.ho, a.lineWidth = c.borderWidth / 2, a.stroke());
        a.fill()
      }
    },
    drawGaoqingRoadBorder: function (a, b, c, e, f) {
      ...
      if (g) for (var a = a[6], i = 0; i < g.length; i++) {
        ...
        if (m && m.length && m[0].borderWidth) for (var n = g[i][1], o = 0; o < n.length; o++) {
          var s = n[o][1];
          f.Nc(s[0], c) && (s["cache" + c] || (s["cache" + c] = f.vm(s[1], c, e, a)), s = s["cache" + c], f.M.Xn(b.canvas.id, s, {
            type: "polygon",
            Ub: k,
            style: m
          }), this.WV(b, s, m))
  ...
  var ed = {
    ...
    VV: function (a, b, c, e) {
      ...
      if (!(c < e.filter)) {
        ...
        a.closePath();
        e.borderWidth && (a.strokeStyle = e.ho, a.lineWidth = e.borderWidth / 2, a.stroke());
        a.fill()
      }
    }
  };
  var fd = {
    parse: function (a, b, c, e, f) {
      for (var g = e.M,
               i = g.ja(), k = Math.pow(2, 18 - i), m = g.Ic.ci(g.Bb()), n = m.lng, o = m.lat, m = g.Cb(), s = m.width, v = m.height, m = [], w = 0; w < a.length; w++) {
        var y = [],
            A = a[w].F_;
        y.x = A[0];
        y.y = A[1];
        y.S5 = A[2];
        for (var B = (A[0] * c * k - n) / k + s / 2, C = (o - (A[1] + 1) * c * k) / k + v / 2, F = 0; F < a[w].length; F++) a[w][F].ML ? this.LM(a[w][F].ML, A, e, b, c, B, C, i, k, s, v, y) : a[w][F].PX ? this.LM(a[w][F].PX, A, e, b, c, B, C, i, k, s, v, y, p, window.K3) : this.aZ(a[w][F].rY, A, e, b, c, B, C, i, k, s, v, y, f);
        m.push(y)
      }
      if (/collision=0/.test(location.search)) {
        a = [];
        for (w = 0; w < m.length; w++) for (F = 0; F < m[w].length; F++) a.push(m[w][F])
      } else a = this.nZ(m, e.M.ja());
      g.TU();
      for (w = 0; w < a.length; w++) if (c = a[w], !c.Gs) if (F = [c.Sf, c.Tf, c.Sf, c.gi, c.fi, c.gi, c.fi, c.Tf, c.Sf, c.Tf], c.style && g.Xn("poi", F, {
        type: "polygon",
        Ub: c.style.Ub,
        style: c.style
      }), "fixed" === c.type) {
        ...
        if (c.ue) if (F) {
          ...
          this.Vr(b, c, e, F,
              function (a) {
                for (var c = 0; c < a.tf.length; c++) E.eK(b, a.tf[c].$d, a.tf[c].ae, a.tf[c].text, a.style, e)
              })
        } else this.Vr(b, c, e);
        if (c.style && !F) for (F = 0; F < c.tf.length; F++) this.eK(b, c.tf[F].$d, c.tf[F].ae, c.tf[F].text, c.style, e)
      } else if ("line" === c.type) for (F = 0; F < c.tO.length; F++) f = c.tO[F],
          ...
          if (N && c.Nc(N[2], k)) {
            ...
            if (v || !(-50 > L || -50 > M || L > n + 50 || M > o + 50)) {
              ...
              if (C) {
                ...
                ca && (E = ca[2], G = ca[3], E = E / 2 * F / 100, G = G / 2 * F / 100, ea.Bs = {
                  $d: L - E / 2,
                  ae: M - G / 2,
                  width: E,
                  height: G
    ...
    Vr: function (a, b, c, e, f) {
      var g = b.ue;
      if ("lanche" !== g) if (fd.ax[g]) this.bK(a, b, fd.ax[g], e, f);
      else {
        var c = c.KK(g),
            i = new Image;
    ...
    bK: function (a, b, c, e, f) {
      ...
      if (b.style && 62203 === s) {
        for (var v = n = m = 0; v < b.tf.length; v++) m < b.tf[v].width && (m = b.tf[v].width),
            n += 20;
        m = Math.ceil(m) + 10
      }
      e && 519 === s && (o = t);
      m !== q && n !== q ? this.TV(a, b, c, 8, m, n) : e && o ? (m = Math.ceil(b.tf[0].width) + 6, this.MV(a, b, c, 12, m, c.height / 2)) : a.drawImage(c, i, k, g.width, g.height);
      f && f(b)
    },
    ...
    QV: function (a, b, c, e, f, g, i, k, m) {
      ...
      0 < k.Tw && (a.lineWidth = k.Tw, a.strokeStyle = k.kL, a.strokeText(f, -g, -i));
      a.fillText(f, -g, -i);
      a.restore()
    },
    eK: function (a, b, c, e, f, g) {
      a.font = fd.Fw(f, g);
      a.fillStyle = f.uK;
      0 < f.Tw && (a.lineWidth = f.Tw, a.strokeStyle = f.kL, a.strokeText(e, b, c));
      a.fillText(e, b, c)
    },
    Fw: function (a, b) {
      var c = a.fontSize / 2,
    ...
    nZ: function (a, b) {
      ...
      for (var f = 0,
        ...
        if ("fixed" === n.type) {
          var y = n.Bs,
              A = n.tf;
          y && (o = y.$d, s = y.ae, v = y.$d + y.width, w = y.ae + y.height);
          for (y = 0; y < A.length; y++) {
            var B = A[y];
            o !== l ? (B.$d < o && (o = B.$d), B.ae < s && (s = B.ae), B.$d + B.width > v && (v = B.$d + B.width), B.ae + B.height > w && (w = B.ae + B.height)) : (o = B.$d, s = B.ae, v = B.$d + B.width, w = B.ae + B.height)
          }
        } else "line" === n.type ? (o = n.Sf, s = n.Tf, v = n.fi, w = n.gi) : "biaopai" === n.type && (w = n.H4, o = w.$d, s = w.ae, v = w.$d + w.width, w = w.ae + w.height);
        o !== l && (n.Sf = o, n.Tf = s, n.fi = v, n.gi = w, c.push(n))
      }
      c.sort(function (a, b) {
      ...
      f = 0;
      for (g = c.length; f < g; f++) if (k = c[f], k.Gs === t) {
        e = k.mJ;
        k = 0;
        for (m = e.length; k < m; k++) c[e[k]].Gs = p
      }
      return c
    },
    ax: {}
  ...
  var ld = {
    drawLink: function (a, b, c, e, f) {
      this.da = f.M.da;
      var g = a[1];
      g && (a = a[6], this.bO(g, c, e, b, a, f, p), this.bO(g, c, e, b, a, f, t))
    },
    bO: function (a, b, c, e, f, g, i) {
      for (var k = 0; k < a.length; k++) {
        var m = a[k][0],
            n = g.gj(m, "line", b);
        if (n && n.length && (!i || n[0].borderWidth)) if (!n[0].yo || kd(n[0].yo, b, this.da)) for (var o = a[k][1], s = 0; s < o.length; s++) {
          var v = o[s][3];
          g.Nc(v[0], b) && (v["cache" + b] || (v["cache" + b] = g.vm(v[1], b, c, f)), v = v["cache" + b], g.M.Xn(e.canvas.id, v, {
            type: "polyline",
            Ub: m,
            style: n
          }), this.RV(e, v, n, i, b))
    ...
    RV: function (a, b, c, e, f) {
      c = c[0];
      if (!e && c.yo && kd(c.yo, f, this.da)) this.YV(a, b, c, kd(c.yo, f, this.da));
      else {
        a.beginPath();
        a.moveTo(b[0], b[1]);
        for (var f = 2,
                 g = b.length; f < g; f += 2) a.lineTo(b[f], b[f + 1]);
        c.borderWidth && e ? (a.strokeStyle = c.ho, a.lineCap = gd[c.xU], a.lineJoin = hd[1], a.lineWidth = c.borderWidth / 2, a.stroke()) : e || (a.strokeStyle = c.Aw, a.lineCap = gd[c.lW], a.lineJoin = hd[1], a.lineWidth = c.qK / 2, a.stroke())
      }
    },
    YV: function (a, b, c, e) {
      if (c = e[1]) {
      ...
      if (e = e[0]) if (e.rd) this.PV(a, b, e);
      else {
  ...
  xd.prototype = {
    hC: function (a, b, c, e, f, g, i, k, m) {
      ...
      if (!window[o + "StyleBody"] && 100 > m) setTimeout(function () {
        ...
        17 <= this.M.ja() ? (n.dK(a, s, f, g, i, c, e), b.ln = p) : setTimeout(function () {
              if (!b.HG) {
                n.dK(a, s, f, g, i, c, e);
                b.ln = p
              }
    ...
    cK: function (a, b, c, e, f, g, i) {
      ...
      !window[m + "StyleBody"] && 100 > i ? setTimeout(function () {
          ...
          100) : (vd || (vd = b), a.hZ = fd.parse(a, c, e, this, f))
    },
    gj: function (a, b, c, e) {
      var f = a + "-" + b + "-" + c;
      if (e) return sd[f] || (sd[f] = this.sg(a, b, c, e)),
          sd[f];
    ...
    Nc: function (a, b) {
      var c;
      td[a] || (c = a.toString(2), 8 > c.length && (c = Array(8 - c.length + 1).join("0") + c), td[a] = c);
      c = td[a];
  ...
  function Kc(a, b, c) {
    ...
    var c = c.urlOpts || {
        ...
        e;
    for (e in c) c.hasOwnProperty(e) && (this.aB = this.aB + "&" + e + "=" + c[e]);
    this.Yg = {};
    this.Gr = [];
    this.Ms = 0;
    this.gx = t;
    this.ax = {};
    a = this.$a.G_;
    Xc[a] ? a = Xc[a] : (b = new Yc(a, l), a = Xc[a] = b);
    this.Bd = a;
    this.M.Bd = this.Bd
  }
      ...
      a.addEventListener("checkvectorclick",
          function (a) {
            ...
            a: {
              ...
              var c = a.offsetY,
                  k = e.Gr.hZ;
              if (k) for (var m = 0; m < k.length; m++) for (var n = k[m], o = 0; o < n.length; o++) if (a = n[o], !a.Gs && a.Bs && b > a.Sf && b < a.fi && c > a.Tf && c < a.gi) {
                b = a.Bs;
                b = {
                  type: 9,
                  name: a.name,
            ...
            b && (a = new Q("onvectorclick"), a.H3 = b, a.kf = "base", this.dispatchEvent(a))
          })
    }
  };
  ...
  fa.update = function (a, b) {
    ...
    this.jF = b.jF;
    b.Zl && (this.Z_ = b.Zl);
    if (this.$a.OE && (b.Ql && this.Ql(), b.o_)) {
      var c = this.Fc,
          e = this.M.Cb(),
          f = e.width,
          e = e.height,
    ...
    if (b.I5) {
      c = this.Tn;
      f = 0;
      for (e = c.childNodes.length; f < e; f++) c.childNodes[f].ln = t
    }
    this.qw = a;
    this.Uo(a)
  };
  fa.Uo = function (a) {
    ...
    w.Aq || (w.eB = q, delete w.eB, w.ln = t, this.Oe.push(w));
    o = [];
    v = f * this.Fc;
    b = 0;
    for (k = a.length; b < k; b++) {
      ...
      if (B) C = B.style,
          ...
          C.width = f + "px",
          C.height = f + "px",
          B.ln ? B.$E && B.$E && this.Gr.push(B.$E) : (B.HG = p, B.eB = q, delete B.eB, o.push([n, s, B]));
      else {
        if (0 < this.Oe.length) {
          var B = this.Oe.shift(),
              F = B.getContext("2d");
    ...
    if (0 === o.length) {
      ...
      e = this.Bd.hs(c);
      f = {};
      for (g = 0; g < this.qw.length; g++) i = this.qw[g],
          i = a + "_" + i[0] + "_" + i[1] + "_" + e + "_" + c,
      this.Yg[i] && (f[i] = this.Yg[i], this.jF && this.Dv.iC.hC(this.Yg[i].m0, this.Yg[i].E_, this.Yg[i].Sl, this.Yg[i].Bm, this.Yg[i].XD, this.Bd.Hd(this.Yg[i].XD), this.Bd.eD(this.Yg[i].XD), this.$a.vD));
      this.Yg = f
    } else {
      this.Ms = o.length;
      this.gx = t;
  ...
  function Ad(a, b, c, e, f) {
          ...
          if (m.R.gk) {
            if (k.Yg[f.id] = {
              ...
              XD: n
                ...
                k.Dv.iC.hC(a, f, b, c, n, k.Bd.Hd(n), k.Bd.eD(n), k.$a.vD), k.$a.OE) {
              n = [];
              n.F_ = [b, c, e];
              if (a[0]) for (o = 0; o < a[0].length; o++) a[0][o][0] === md && n.push({
                ML: a[0][o]
              });
    ...
    i[g].Lk = setTimeout(function () {
          3 > i[g].dN ? (i[g].dN++, i[g].status = "init", Ad(k, b, c, e, f)) : i[g] = q
        },
        4E3)
  }
  ...
  fa.Me = function (a) {
    if (a instanceof Kc) {
      for (var b = 0; b < this.bf.length; b++) if (this.bf[b] === a) return;
      this.bf.push(a);
      a.xa();
  ...
  fa.Wf = function (a) {
    if (a instanceof Kc) {
      for (var b = 0; b < this.bf.length; b++) if (this.bf[b] === a) {
        this.bf.splice(b, 1);
        break
      }
      a.remove()
  ...
  z.extend(ae.prototype, {
    ...
    mV: function () {
      ...
      if (this.page < this.Vf) e = 0 == this.page % this.Vf ? this.page - this.Vf - 1 : this.page - this.page % this.Vf + 1,
          b = e + this.Vf - 1;
      else {
      ...
      this.page > this.Id - this.Vf && this.page >= this.Vf && (e = this.Id - this.Vf + 1, b = this.Id);
      for (f = e; f <= b; f++) 0 < f && (f == this.page ? a.push('<span style="margin-right:3px">' + f + "</span>") : 1 <= f && f <= this.Id && (e = '<span><a style="color:#7777cc;margin-right:3px" href="javascript:void(0)" onclick="{temp3}">[' + f + "]</a></span>", a.push(e.replace("{temp3}", "BMap.I('" + this.da + "').toPage(" + f + ");"))));
    ...
    toPage: function (a) {
      a = a ? a : 1;
      "function" == typeof this.vJ && (this.vJ(a), this.page = a);
      this.update && this.za()
    }
  });
  ...
  function Geolocation(a) {
    ...
    K.load("othersearch",
        function () {
          for (var a = 0,
                   e; e = b.me[a]; a++) b[e.method].apply(b, e.arguments)
        })
  }
  ...
  function Qa(a, b) {
    function c() {
      f.m.visible ? ("inter" === f.Ie && Wa() && f.m.haveBreakId && f.m.indoorExitControl === p ? z.U.show(f.xq) : z.U.$(f.xq), this.m.closeControl && this.yf && this.M && this.M.Qa() === this.P ? z.U.show(f.yf) : z.U.$(f.yf), this.m.forceCloseControl && z.U.show(f.yf)) : (z.U.$(f.yf), z.U.$(f.xq))
    }
    ...
    this.Pg = [];
    this.Nq = [];
    "cvsRender" == this.Sj || Pa() ? (this.Kj = 90, this.Mj = -90) : "cssRender" == this.Sj && (this.Kj = 45, this.Mj = -45);
    this.Rq = t;
    var f = this;
    this.Bn = function () {
    ...
    this.m.bS !== p && (this.Bn(), D.Qp("cus.fire", "count", "z_loadpanoramacount"));
    this.TS(this.P);
  ...
  z.extend(Qa.prototype, {
    ...
    Ac: function (a, b, c) {
      ...
      a != this.bb && (this.jl = this.bb, this.kl = this.Kb, this.bb = a, this.Ie = b || "street", this.Kb = q, c && c.pov && this.od(c.pov))
    },
    ua: function (a) {
      a.Wb(this.Kb) || (this.jl = this.bb, this.kl = this.Kb, this.Kb = a, this.bb = q)
    },
    od: function (a) {
      if (a) {
        var a = this.Ia.pitch,
    ...
    Pc: function (a) {
      a != this.Kc && (a > ye && (a = ye), a < ze && (a = ze), a != this.Kc && (this.Kc = a), "cssRender" === this.Sj && this.od(this.Ia))
    },
    OA: function () {
      if (this.M) for (var a = this.M.Nw(), b = 0; b < a.length; b++) (a[b] instanceof W || a[b] instanceof tc) && a[b].point && this.Ba.push(a[b])
    },
    IE: ba("M"),
    ot: function (a) {
      this.Kf = a || "none"
  ...
  z.extend(De.prototype, {
    ...
    vn: function () {
      var a = 0,
          b, c;
      this.W && (b = this.W.ka(), (c = this.ka()) && !c.Wb(b) && (a = S.mk(b, c)));
      return a
    },
    $: function () {
      aa("hide\u65b9\u6cd5\u672a\u5b9e\u73b0")
  ...
  z.extend(dc.prototype, {
    ga: function () {
      ...
      b.addEventListener("iid_changed",
          function () {
            c.Qg(dc.Uk + "qt=idata&iid=" + b.Iz + "&fn=",
                function (b) {
  ...
  z.extend(Oe, {
    ...
    PK: function (a, b, c, e, f) {
      ...
      return (Oe.du + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
          function (a, b) {
            return g[b]
          })
    }
  ...
  function uf(a, b) {
    ...
    c.ga(lf, window);
    c.ga(mf);
    !hf && "none" != c.options.sO && (c.ga("DOMMouseScroll"), c.ga("mousewheel"));
  ...
  uf.prototype = {
    ...
    Qq: function (a, b) {
      this.Qk || (a = this.Mo ? a : 0, b = this.Nm ? b : 0, this.options.Nk ? this.Nb.style[Ze] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + tf : (a = Qe.round(a), b = Qe.round(b), this.Nb.style.left = a + "px", this.Nb.style.top = b + "px"), this.x = a, this.y = b, this.IA("h"), this.IA("v"))
    },
    IA: function (a, b) {
      var c = "h" == a ? this.x : this.y;
      this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.HC || (c = this[a + "ScrollbarIndicatorSize"] + Qe.round(3 * c), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px"), c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.HC ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - Qe.round(3 * (c - this[a + "ScrollbarMaxScroll"])), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px", c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))), this[a + "ScrollbarWrapper"].style[df] = "0", this[a + "ScrollbarWrapper"].style.opacity = b && this.options.Yw ? "0" : "1", this[a + "ScrollbarIndicator"].style[Ze] = "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + tf)
    },
    YP: function (a) {
      if (a.OQ === p) return this.hB = a.target,
          this.zw = Date.now(),
          p;
      if (this.hB && this.zw) {
        if (600 < Date.now() - this.zw) return this.zw = this.hB = q,
            p
      } else {
      ...
      if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.pZ = p,
          a.stopPropagation(),
          a.preventDefault(),
          this.zw = this.hB = q,
          t
    ...
    qv: function (a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom && (hf && 1 < a.touches.length) && (e = Qe.abs(a.touches[0].pageX - a.touches[1].pageX), c = Qe.abs(a.touches[0].pageY - a.touches[1].pageY), this.O_ = Qe.sqrt(e * e + c * c), this.zx = Qe.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.qF) / 2 - this.x, this.Ax = Qe.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.rF) / 2 - this.y, this.options.Zo && this.options.Zo.call(this, a));
        if (this.options.qx && (this.options.Nk ? (c = getComputedStyle(this.Nb, q)[Ze].replace(/[^0-9\-.,]/g, "").split(","), e = +(c[12] || c[4]), c = +(c[13] || c[5])) : (e = +getComputedStyle(this.Nb, q).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Nb, q).top.replace(/[^0-9-]/g, "")), e != this.x || c != this.y)) this.options.qi ? this.Yd(qf) : sf(this.sB),
            this.qj = [],
            this.Qq(e, c),
    ...
    qS: function (a) {
      ...
      this.options.GM && this.options.GM.call(this, a);
        ...
        this.jh = b.pageX;
        this.kh = b.pageY;
        if (0 < f || f < this.fe) f = this.options.io ? this.x + c / 2 : 0 <= f || 0 <= this.fe ? 0 : this.fe;
        if (g > this.of || g < this.nd) g = this.options.io ? this.y + e / 2 : g >= this.of || 0 <= this.nd ? this.of : this.nd;
        this.cC += c;
        this.dC += e;
        this.Iv = Qe.abs(this.cC);
        this.Jv = Qe.abs(this.dC);
        6 > this.Iv && 6 > this.Jv || (this.options.VD && (this.Iv > this.Jv + 5 ? (g = this.y, e = 0) : this.Jv > this.Iv + 5 && (f = this.x, c = 0)), this.ih = p, this.Qq(f, g), this.XB = 0 < c ? -1 : 0 > c ? 1 : 0, this.YB = 0 < e ? -1 : 0 > e ? 1 : 0, 300 < i - this.startTime && (this.startTime = i, this.Ft = this.x, this.Gt = this.y), this.options.DM && this.options.DM.call(this, a))
      }
    },
    Au: function (a) {
        ...
        b.options.Yo && b.options.Yo.call(b, a);
          ...
          if (b.ih) {
            if (300 > k && b.options.qx) {
              ...
              if (b.y > b.of && f > b.of || b.y < b.nd && f < b.nd) i = {
                Fa: 0,
                time: 0
              }
            }
            ...
            if (hf) if (b.WJ && b.options.zoom) clearTimeout(b.WJ),
                b.WJ = q,
            ...
            b.options.Yo && setTimeout(function () {
              ...
              "select" != f && "input" != f && "textarea" != f ? (f = Pe.createEvent("MouseEvents"), f.initMouseEvent("click", p, p, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, q), f.OQ = p, e.dispatchEvent(f)) : e.focus()
            }
            b.In(400)
          }
    ...
    In: function (a) {
      ...
      if (b == this.x && c == this.y) {
        if (this.ih && (this.ih = t, this.options.xx && this.options.xx.call(this)), this.Zh && this.options.Yw && ("webkit" == Se && (this.jL.style[df] = "300ms"), this.jL.style.opacity = "0"), this.ri && this.options.Yw) "webkit" == Se && (this.lO.style[df] = "300ms"),
    ...
    UT: function (a) {
      ...
      if ("zoom" == b.options.sO) {
        if (e = b.scale * Math.pow(2, 1 / 3 * (e ? e / Math.abs(e) : 0)), e < b.options.Pk && (e = b.options.Pk), e > b.options.Ap && (e = b.options.Ap), e != b.scale) !b.ly && b.options.Zo && b.options.Zo.call(b, a),
            b.ly++,
    ...
    RT: function (a) {
      a.target == this.Nb && (this.Yd(qf), this.UA())
    },
    UA: function () {
      var a = this,
          b = a.x,
          ...
          g,
          i;
      a.Ll || (a.qj.length ? (f = a.qj.shift(), f.x == b && f.y == c && (f.time = 0), a.Ll = p, a.ih = p, a.options.qi) ? (a.II(f.time), a.Qq(f.x, f.y), a.Ll = t, f.time ? a.ga(qf) : a.In(0)) : (i = function () {
        var k = Date.now(),
            m;
        if (k >= e + f.time) {
          a.Qq(f.x, f.y);
    ...
    Oj: function (a) {
      for (var b = -a.offsetLeft,
          ...
          c -= a.offsetTop;
      a != this.Qm && (b *= this.scale, c *= this.scale);
      return {
        left: b,
        top: c
      }
    ...
    yI: function (a, b) {
      ...
      f = this.Ve.length - 1;
      c = 0;
      for (e = this.Ve.length; c < e; c++) if (a >= this.Ve[c]) {
        f = c;
        break
      }
    ...
    refresh: function () {
      ...
      this.hv("h");
      this.hv("v");
      this.Qk || (this.Nb.style[af] = "0", this.In(400))
    },
    scrollTo: function (a, b, c, e) {
      ...
      a = 0;
      for (b = f.length; a < b; a++) f[a].rZ && (f[a].x = this.x - f[a].x, f[a].y = this.y - f[a].y),
          this.qj.push({
            x: f[a].x,
            y: f[a].y,
            time: f[a].time || 0
    ...
    zoom: function (a, b, c, e) {
      var f = c / this.scale;
      this.options.Nk && (this.Qk = p, e = e === l ? 200 : e, a = a - this.qF - this.x, b = b - this.rF - this.y, this.x = a - a * f + this.x, this.y = b - b * f + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.fe ? this.fe : this.x, this.y = this.y > this.of ? this.of : this.y < this.nd ? this.nd : this.y, this.Nb.style[af] = e + "ms", this.Nb.style[Ze] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + tf, this.Qk = t)
    }
  };
  ...
  D.zk(function (a) {
    ...
    a.addEventListener("albums_visible_changed",
        function () {
          a.m.albumsControl === p ? (b ? b.Lx(a.Xb()) : (b = new vf(a.m.albumsControlOptions), b.xa(a)), b.show()) : b.$()
        });
  ...
  z.extend(vf.prototype, {
        ...
        z.V(b, "click",
            function (a) {
              if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
                c.xl(c.sG[a]);
                for (var e = b.getElementsByTagName("li"), f = 0, g = e.length; f < g; f++) e[f].childNodes[0].getAttribute("dataindex") === a ? z.U.eb(e[f], "pano_catlogLiActive") : z.U.qc(e[f], "pano_catlogLiActive")
              }
            });
        var a = O("div"),
            e = O("a"),
    ...
    xl: function (a) {
      this.Qj = a;
      this.m.showCatalog && (0 < this.Ei.length ? (Wa() ? this.kV() : this.nV(), this.Qc.offsetLeft = 60) : (this.$r && (this.P.removeChild(this.$r), this.$r = q, this.Qc.fg.style.left = "0px"), this.Bi && (this.P.removeChild(this.Bi), this.Bi = q), this.Qc.offsetLeft = 0));
      var b = this.SW(a);
      Wa() && (this.Ei && 0 < this.Ei.length && this.m.showExit && this.lz) && (this.Qc.offsetLeft += this.dg.width + 8, this.$r ? this.$r.innerHTML = this.lz : this.lV());
      this.Ih.innerHTML = b;
      this.Ih.style.width = (this.dg.width + 8) * a.length + 8 + "px";
      a = this.P.offsetWidth;
      b = this.Ih.offsetWidth;
      this.Qc.gs && (b += this.Qc.gs());
      b < a - 2 * this.Qc.ui - this.Qc.offsetLeft ? this.P.style.width = b + this.Qc.offsetLeft + "px" : (this.P.style.width = isNaN(Number(this.m.maxWidth)) === p ? this.m.maxWidth : this.m.maxWidth + "px", b < this.P.offsetWidth - 2 * this.Qc.ui - this.Qc.offsetLeft && (this.P.style.width = b + this.Qc.offsetLeft + "px"));
      this.Qc.refresh();
    ...
    SW: function (a) {
      for (var b, c, e, f, g = [], i = this.dg.height, k = this.dg.width, m = 0; m < a.length; m++) b = a[m],
          recoType = b.recoType,
          e = b.panoId,
          f = b.name,
          c = b.heading,
    ...
    rc: function (a) {
      if (!Ya(a) || isNaN(a) || a < Vb || 3 < a) a = this.defaultAnchor;
      var b = this.P,
    ...
    uP: function () {
      ...
      z.V(this.Vj, "click",
          function (b) {
            if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.Wc) a.kp(b),
